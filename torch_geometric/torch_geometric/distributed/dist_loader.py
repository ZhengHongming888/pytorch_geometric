...
class DistLoader(object):
  ...
  def __init__(self,
    ...
    if isinstance(self.worker_options, CollocatedDistSamplingWorkerOptions):
      ...
      print(f"-------- self.worker_options.worker_world_size={self.worker_options.worker_world_size}, current_ctx={current_ctx} ")
      ...
      print(f"-------- self.num_data_partitions={self.num_data_partitions}, self.data_partition_idx={self.data_partition_idx}, ntypes={ntypes}, etypes={etypes} ")
      ...
      print(f"------- self._producer_id={self._producer_id} ")
      ...
      print(f"----- self._channel={self._channel} ")
