    ...
    def load(
        ...
        if partition_format=="pyg":
            ...
            if(self.meta["is_hetero"]):
                ...
                print(f"---------- edge_id_dict={edge_id_dict}, edge_index_dict={edge_index_dict}, num_nodes_dict={num_nodes_dict}, edge_attr_dict={edge_attr_dict}   ")
                print(f"---------- node_id_dict={node_id_dict}, x_dict={x_dict} ")                
                ...
                print(f"--------888------- tensor_attrs={tensor_attrs}  ")
                
                print(f"------------ self.graph={self.graph}    ")
                print(f"------------ self.edge_features={self.edge_features}    ")
                print(f"------------ self.node_features={self.node_features}    ")
                ...
                if(self.meta["is_hetero"]):
                    ...
                    if self.node_features is not None:
                        ...
                        for item in tensor_attrs:
                            ...
                            print(f"------  item.group_name={item.group_name}, data[item.group_name].x={data[item.group_name].x} ")
