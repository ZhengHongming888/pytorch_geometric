...
from ..typing import (
  NodeType, EdgeType, as_str, reverse_edge_type, Tuple
)
...
class DistLoader(object):
  ...
  def __init__(self,
    ...
    if self.data is not None:
      ...
      d1 = self.data
      print(f"----- d1={d1} ----")
      d1_node_type = self.data.get_node_types()
      print(f"------- {d1_node_type}")
      
      print(f"------------ self.data.get_node_types()={self.data.get_node_types()}")
      print(f"------------ self.data.get_edge_types()={self.data.get_edge_types()}")
