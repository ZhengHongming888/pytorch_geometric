...
class DistLoader():  # , RPCMixin):
    ...
    def __init__(self,
        ...
        self.current_ctx = current_ctx #get_context()
        self.master_addr = str(master_addr)
        self.master_port = int(master_port)
        self.device = device
        self.filter_per_worker = filter_per_worker
        self.channel = None #torch.multiprocessing.Queue() if async_sampling else None
        self.num_workers = kwargs.get('num_workers', 0)
        self.num_rpc_threads = kwargs.pop('num_rpc_threads', 16)
        self.rpc_timeout = kwargs.pop('rpc_timeout', 180)
