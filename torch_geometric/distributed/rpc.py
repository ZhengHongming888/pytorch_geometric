...
r""" Master address used by rpc agent."""

_rpc_master_port: int = None
r""" Master port used by rpc agent."""
...
def get_rpc_master_addr():
    r""" Get the master address for rpc communication. """
    return _rpc_master_addr


@_require_initialized
def get_rpc_master_port():
    r""" Get the master port for rpc communication."""
